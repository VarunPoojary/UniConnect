...
import com.example.mitadttrial.ChatDetailActivity;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder>
{
    ...
    public UsersAdapter(ArrayList<ReadWriteUserDetails> list, Context context)
    {
        this.list = list;
    ...
    {
        ReadWriteUserDetails users = list.get(position);
